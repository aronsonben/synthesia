 ...
 */
export default function PalettesPPT({ tracks }: { tracks: TrackWithAnalysis[] }) {
  ...
  return (
    <div className="h-[95vh] flex flex-col items-center justify-between w-full pt-8 bg-blue-100" id="palettes">
      ...
      <div id="palettes-holder" className="flex flex-col w-[90vw] md:w-full md:justify-center md:items-center bg-blue-100">
        {tracks.map((track) => {
          // Custom Hardcode to only show three:
          if (track.id != 91 && track.id != 92 && track.id != 93 && track.id != 20 && track.id != 8 && track.id != 9) {
            return null;
          }
